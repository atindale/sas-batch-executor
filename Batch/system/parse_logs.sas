options ls=120
        emailsys=smtp EMAILAUTHPROTOCOL=login
        emailpw=<password> emailid="<email_address>";
...
filename reports email "alan.tindale@ingdirect.com.au"; 
...
data x;
  file reports;
  put '!EM_TO! alan.tindale@scorpio.net.au';
  put "!EM_SUBJECT! &job_name Completed";
  put " ";
  put "&job_name has completed. Reports are attached.";
  put " ";
